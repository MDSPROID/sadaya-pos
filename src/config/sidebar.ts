...
const sidebarConfig: SidebarMenuItem[] = [
  {
    ...
    allowedRoles: ['Super Admin', 'Admin', 'Kasir', 'CS', 'Manager', 'Operator', 'Designer', 'Finishing'], // Contoh peran yang diizinkan
  },
  {
    name: 'Status Order',
    path: '/dashboard/status_order', 
    icon: Clock,
    allowedRoles: ['Super Admin', 'Admin', 'Kasir', 'CS', 'Manager', 'Operator', 'Designer', 'Finishing'],
  },
  {
    name: 'Master Data',
    icon: Users,
    allowedRoles: ['Super Admin', 'Admin', 'Kasir', 'CS', 'Manager', 'Operator', 'Designer', 'Finishing'], // Roles that can see Master Data section
    children: [
      {
        name: 'Produk',
      ...
      },
      {
        ...
        allowedRoles: ['Super Admin', 'Admin', 'Kasir', 'CS', 'Manager', 'Operator', 'Designer', 'Finishing'], // atur role yang boleh lihat menu ini
      },
      {
        name: 'Bank',
  ...
  },
  {
    name: 'Laporan',
    icon: BarChart,
    allowedRoles: ['Super Admin', 'Admin', 'Kasir', 'CS', 'Manager', 'Operator', 'Designer', 'Finishing'], // Hanya Super Admin yang bisa melihat menu Laporan
    children: [
      {
        name: 'Penjualan',
